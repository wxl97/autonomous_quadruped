...
if("TRUE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /home/fona/i2ROS/autonomous_quadruped/src/perception)
  set(perception_DEVEL_PREFIX /home/fona/i2ROS/autonomous_quadruped/devel/.private/perception)
  ...
  set(perception_INSTALL_PREFIX /home/fona/i2ROS/autonomous_quadruped/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Yue Zhang <yue22.zhang@tum.de>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fona/i2ROS/autonomous_quadruped/src/perception/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/fona/i2ROS/autonomous_quadruped/devel/.private/perception/lib;/home/fona/i2ROS/autonomous_quadruped/devel/lib;/opt/ros/noetic/lib)
...
set(depends "roscpp;sensor_msgs;tf2_ros;pcl_ros;pcl_conversions;image_transport;cv_bridge")
